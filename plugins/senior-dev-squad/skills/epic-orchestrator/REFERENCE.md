# Epic Orchestrator — Reference Detail

Full specifications for the output schema, worked examples, model calibration, and the 10-phase orchestration pipeline. Linked from [SKILL.md](SKILL.md).
