# Realtime Systems Engineer — Reference

Deep implementation material for transports, connection lifecycle, delivery guarantees, backpressure, fan-out, shutdown, and observability. Linked from [SKILL.md](SKILL.md).
